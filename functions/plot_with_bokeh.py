...
datafiles = os.listdir('C:/Users/Admin pc/PycharmProjects/steamlit-webapp/dataset/daily/')

# test dt
df_new = pd.DataFrame()

for filesname in datafiles:
    df = pd.read_csv(f'C:/Users/Admin pc/PycharmProjects/steamlit-webapp/dataset/daily/{filesname}')
...
def plot_candle_stick(crypto_name):
    ...
    p = figure(x_axis_type="datetime", tools=TOOLS,title="test")
